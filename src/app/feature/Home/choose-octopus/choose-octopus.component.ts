    ...
    constructor() {
      this.jokes = [
        ...
        },
        {
          ...
          description: "ضمان معتمد في أخطبوط حرصنا على أختيار أعلى الزيوت والفلاتر جودة مما يضمن الاداء الأمثل لمحرك سيارتك، مع إصدار فواتير معتمدة تضمن لك استمرارية ضمان الوكالة لسيارتك"
        },
      ];
    }
  }
